...
<body>
	<div class="data_list">
		...
		<div class="data_content">
			<form action="student!modifyPassword" method="post" onsubmit="return checkForm()">
				<table width="40%" align="center">
					<tr>
						<td><label>用户名：</label></td>
						<td><input type="text" value="${currentStudent.id }" name="student.id" readonly="readonly" /></td>
					</tr>
					<tr>
