			...
			<form action="question!save" method="post" onsubmit="return checkForm()">
				<table width="90%" align="center">
					...
					<tr>
						...
						<td><input type="text" id="joinTime" class="Wdate" onClick="WdatePicker()" name="question.joinTime"
					...
					<tr>
						<td><input type="hidden" id="questionId" name="question.id" value="${question.id }" />
							<button class="btn btn-primary" type="submit">保存</button></td>
						<td>
							<button class="btn btn-primary" type="button" onclick="javascript:history.back()">返回</button>&nbsp;&nbsp;<font id="error"
