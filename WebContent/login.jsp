...
<body>
	<div align="center" style="padding-top: 20px;">
		<form action="student!login" method="post" onsubmit="return checkForm()">
			<!-- 	table的大小根据 图片的大小（login.jpg） -->
			<table width="1004" height="584" background="image/login.jpg" cellspacing="1">
				<tr height="20%">
					<td colspan="4"></td>
				</tr>
				<tr height="10%">
				...
				<tr height="10%">
				<td width="68%"></td>
					<td width="10%" align="center"><button class="btn btn-primary" type="button"
							onclick="javascript:window.location.href='${pageContext.request.contextPath}/login2.jsp'">后台管理</button></td>
					<td></td>
				</tr>
			</table>
		</form>
