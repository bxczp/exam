...
CREATE TABLE `t_exam` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_l14kkd2w86mpy8v2snw37hskx` (`paperId`) USING BTREE,
  KEY `FK_sl2v4qucyp0qe9yvnk6icka10` (`studentId`) USING BTREE,
...
-- ----------------------------
INSERT INTO `t_manager` VALUES ('1', '管理员', '123456', '11');
...
INSERT INTO `t_paper` VALUES ('5', '2014-07-10 19:45:33', '22');
...
CREATE TABLE `t_question` (
  ...
  `paperId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_ebouwob97chiilpjmc6gtgwkw` (`paperId`) USING BTREE,
...
-- ----------------------------
INSERT INTO `t_student` VALUES ('JS110', null, null, null, null, null);
...
INSERT INTO `t_student` VALUES ('JS1251', null, null, null, null, null);
